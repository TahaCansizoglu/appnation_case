...
class Failure with _$Failure {
  ...
  const factory Failure.locationPermissionDenied({required String message}) = _LocationPermissionDenied;
  const factory Failure.locationServiceDisabled({required String message}) = _LocationServiceDisabled;
}
